      ...
      <main className=''>
        ...
        <div className="">
          {auth?.user?.company_id !== null &&
            <>
              {/* <div className='flex items-center justify-start bg-gray-50 rounded-md shadow-md border border-white'> */}
                <div className="flex items-center justify-start"><DatePickerSingle />
                {/* <IoSearch onClick={() => handlerFilter()} /> */}
                </div>
              {/* </div> */}
